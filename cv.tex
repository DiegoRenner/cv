...
% Sections formatting
\titleformat{\section}{
	\vspace{-4pt}\rmfamily\scshape\raggedright\large }{}{0em}{}[\color{black}\titlerule \vspace{-5pt}]
% ---
...
\begin{minipage}[T]{0.36\textwidth}
		\begin{flushright}
		\includegraphics[width=\textwidth, right]{portrait.jpg}
		\end{flushright}
\end{minipage}
% ---
...
\resumeItemListStart
\resumeItem{\href{https://www.nektar.info/}{Development of GPU Compressible Flow Solver for Turbomachinery (C++) for Rolls-Royce.}}
\resumeItemListEnd
\resumeSubheading
{ETH Zurich}{Zurich, Switzerland}
{M.Sc. Mathematics}{September 2021 - December 2023}
\resumeItemListStart
\resumeItem{\href{https://github.com/DiegoRenner/jaxFlowSim}{Degree completed with a thesis on differentiable haemodynamics solver in JAX (Python) for Apple In Incc.}}
\resumeItemListEnd
\resumeSubheading
{ETH Zurich}{Zurich, Switzerland}
...
\resumeSubheading
{\href{https://www.plantime.io/}{plantime.io}}{Basel, Switzerland}
...
\resumeSubheading
{Jugendsession}{Bern}
{Formulating policy suggestions to be passed on to the Parliament: \href{https://forderungen.jugendsession.ch/de/demand/58/show}{Neutrality in Media.}}{November 2011}
\resumeSubheading
{Jugendsession}{Bern}
{Formulating policy suggestions to be passed on to the Parliament: \href{https://forderungen.jugendsession.ch/de/demand/102/show}{Electronic Voting.}}{November 2009}
\resumeSubHeadingListEnd
